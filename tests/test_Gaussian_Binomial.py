...
from probability_distributions_functions import Gaussian
from probability_distributions_functions import Binomial

class TestGaussianClass(unittest.TestCase):
    def setUp(self):
        self.gaussian = Gaussian(25, 2)
        self.gaussian.read_data_file(r'C:\Users\numbers.txt')
...
class TestBinomialClass(unittest.TestCase):
    def setUp(self):
        ...
        self.binomial.read_data_file(r'C:\Users\numbers_binomial.txt')
